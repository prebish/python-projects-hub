...
# Your Impl
from DLL import DoublyLL, Node
# Solution
from DLLSolutions import DoublyLL as Solution
#endregion

def test_empty():
    l = DoublyLL()
    assert l.is_empty(), "Observed: False || Expected: True"

    l.insert_head(0)
    assert not l.is_empty(), "Observed: False || Expected: True" 
