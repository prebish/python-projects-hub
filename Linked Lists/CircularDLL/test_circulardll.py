...
To run these tests, use VS Code extensions or 'pytest test_circulardll.py' in terminal.
'''
#region I M P O R T S
import pytest, time

# Your LL
from circulardll import CircularDLL, Node
# Solution LL
from solution_circulardll import CircularDLL as Solution
#endregion
